...
public final class ActivityRegistrationBinding implements ViewBinding {
  ...
  @NonNull
  public final FragmentContainerView registrationHostFragment;

  private ActivityRegistrationBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView registrationHostFragment) {
    this.rootView = rootView;
    this.registrationHostFragment = registrationHostFragment;
  }
  ...
  public static ActivityRegistrationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.registration_host_fragment;
      FragmentContainerView registrationHostFragment = ViewBindings.findChildViewById(rootView, id);
      if (registrationHostFragment == null) {
        break missingId;
      }

      return new ActivityRegistrationBinding((ConstraintLayout) rootView, registrationHostFragment);
    }
